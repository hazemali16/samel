  ...
  <div className="pt-40 w-1/2  max-xl:w-3/4 max-sm:w-11/12 max-sm:px-5 mx-auto opacity-0 translate-y-10 duration-500" id="products">
    ...
    <div className="grid grid-cols-2 max-md:grid-cols-1 gap-20">
        <div className="shadow-lg rounded-lg">
            ...
            <p className="leading-relaxed min-h-24">رفيقك في كل المواقف، تصميم عملي يريحك من تعب البحث عن المفكات الضايعة، تفك وتركب فيه مع طقم متنوع من 51 رأس، يناسب كل أنواع المسامير.</p>
            <ul className="list-disc p-5">
              <li>عملي وسهل</li>
              <li className="my-3">بجودة عالية ومُبتكر</li>
              <li>51 رأس متغيير</li>
              <li className="my-3">كشاف للإضاءة</li>
              <li>بطارية قوية</li>
            </ul>
            </div>
        </div>
        <div className="shadow-lg rounded-lg">
            ...
            <p className="leading-relaxed h-24">ابتكار ولا أروع، يلصق لك أي شيء على أي سطح بدون أثر، مع إمكانية غسله وتكرار استخدامه.</p>
            <ul className="list-disc p-5">
              <li>ما يترك أثر</li>
              <li className="my-3">ثابت وقوي بوجهين</li>
              <li className="mb-3">شفاف وعصري للإستخدامات متعددة</li>
              <li>مقاوم للماء</li>
            </ul>
